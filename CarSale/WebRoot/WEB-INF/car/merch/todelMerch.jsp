...
font-size: 15px;
  ...
  <head>
    ...
    <title>My JSP 'tolookMerch.jsp' starting page</title>
...
font-weight:bold;
  ...
  <span class="current">当前位置：<span class="manage">车辆信息管理</span>-><span class="view">删除车辆信息</span></span>
  <div class="main">
  <form action="merch/toDelMerch" method="post" class="form">
  ...
  <input class="reset" type="reset" value="重置">
    ...
    <td>${m.unitcost }</td>
    <td>${m.others }</td>
    <td><a href="merch/DelMerch?merchid=${m.merchid }"><img src="res/img/bg_button_del.gif"></a></td>
    </tr>
    </c:forEach>
    </table>
