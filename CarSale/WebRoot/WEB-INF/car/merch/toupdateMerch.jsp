...
font-weight:bold;
  ...
  <span class="current">当前位置：<span class="manage">车辆信息管理</span>-><span class="view">修改车辆信息</span></span>
  <div class="main">
  <form action="merch/toUpdateMerch" method="post" class="form">
  ...
  <input class="reset" type="reset" value="重置">
    ...
    <td>${m.unitcost }</td>
    <td>${m.others }</td>
    <td><a href="merch/UpdateMerch?merchid=${m.merchid }"><img src="res/img/bg_button_update.gif"></a></td>
    </tr>
    </c:forEach>
    </table>
