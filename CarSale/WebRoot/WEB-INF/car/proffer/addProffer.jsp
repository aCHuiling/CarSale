...
<html>
  <head>
    ...
    <title>My JSP 'addProffer.jsp' starting page</title>
...
<script type="text/javascript" src="res/js/jquery-1.12.4.js"></script>
  ...
  if(data=="true")
  {
  content.innerHTML="该供货商号已经存在，请重新输入！"
  return false;
  }else{
  if(vl==""){
  content.innerHTML="供货商号不能为空！"
  return false;
  }
  else{
  content.innerHTML="该供货商号可以使用！"
  return true;
  }
  }
  }
...
font-weight:bold;
  ...
  <span class="current">当前位置：<span class="manage">供货商信息管理</span>-><span class="view">添加供货商信息</span></span>
    <div class="main">
    <form action="proffer/AddProffer" onsubmit="return ckAllForm()" class="form">
    <table>
    <tr>
    <td>供货商号：</td><td><input name="profferid" onblur="ckId(this)"><span id="spId"></span></td>
    </tr>
    <tr>
    <td>名称：</td><td><input name="fullname" onblur="ckName(this)"><span id="spName"></span></td>
    </tr>
    <tr>
    <td>联系人：</td><td><input name="contactperson" onblur="ckContact(this)"><span id="spContact"></span></td>
    </tr>
    <tr>
    <td>联系电话：</td><td><input name="phone" onblur="ckPhone(this)"><span id="spPhone"></span></td>
    </tr>
    <tr>
    <td>联系地址：</td><td><input name="adress" onblur="ckAdress(this)"><span id="spAdress"></span></td>
    </tr>
    <tr>
    <td>开户行：</td><td><input name="openingbank"></td>
    </tr>
    <tr>
    <td>银行帐号：</td><td><input name="accountid"></td>
    </tr>
    <tr>
    <td>备注：</td><td><input name="others"></td>
    </tr>
    </table>
