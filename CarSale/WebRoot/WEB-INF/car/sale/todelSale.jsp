...
<html>
  <head>
    ...
    <title>My JSP 'todelSale.jsp' starting page</title>
...
font-weight:bold;
  ...
  <body>
    ...
    <span class="current">当前位置：<span class="manage">销售信息管理</span>-><span class="view">删除销售信息</span></span>
  <div class="main">
  <c:if test="${userModel.ismanage==2 }">
  <form action="sale/toDelSale" method="post" class="form">
    ...
    <td style="color: blue;"><a href="sale/DelSale?salebillid=${s.salebillid }"><img src="res/img/bg_button_del.gif"></a></td>
    </tr>
    </c:forEach>
    </table>
