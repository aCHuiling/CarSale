...
<html>
  <head>
    ...
    <title>My JSP 'lookImport.jsp' starting page</title>
...
font-weight:bold;
  ...
  <span class="current">当前位置：<span class="manage">进货信息管理</span>-><span class="view">查看进货信息</span></span>
    <div class="main">
    <form action="import/lookImport" method="post" class="form">
